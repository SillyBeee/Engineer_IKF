...
private:
  // 回调函数
  void
  TargetEndPoseCallback(const std_msgs::msg::Float32MultiArray::SharedPtr msg);
  void TargetJointPoseCallback(
      const std_msgs::msg::Float32MultiArray::SharedPtr msg);
  void
  JointStateCallback(const std_msgs::msg::Float32MultiArray::SharedPtr msg);
  void JoyDataCallback(const std_msgs::msg::Float64MultiArray::SharedPtr msg);

  // 耗时回调组，用于多线程执行器
  rclcpp::CallbackGroup::SharedPtr callback_group_time_consuming_;
  // 发布订阅接口
  rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr
      sub_target_end_pose_; // 接受目标末端位姿指令
  rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr
      sub_target_joint_pose_; // 接受目标关节姿态指令
  rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr
  ...
  rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr
      pub_target_joint_vel_; // 发布给下位机的目标关节速度
  rclcpp::Publisher<sensor_msgs::msg::JointState>::SharedPtr
      pub_joint_state_; // 转发给robot_description的关节状态用于实时更新rviz与机器人模型
